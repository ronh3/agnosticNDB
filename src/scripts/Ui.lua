...
local function builtin_themes()
  return {
    ...
    alchemist = { accent = "goldenrod", border = "saddle_brown", text = "antique_white", muted = "tan" },
    apostate = { accent = "dark_orchid", border = "black", text = "plum", muted = "thistle" },
    bard = { accent = "medium_aquamarine", border = "dark_slate_blue", text = "light_cyan", muted = "light_steel_blue" },
    blademaster = { accent = "steel_blue", border = "dim_grey", text = "white_smoke", muted = "light_grey" },
    depthswalker = { accent = "dark_turquoise", border = "midnight_blue", text = "light_cyan", muted = "cadet_blue" },
    druid = { accent = "forest_green", border = "dark_olive_green", text = "honeydew", muted = "pale_green" },
    infernal = { accent = "firebrick", border = "black", text = "misty_rose", muted = "rosy_brown" },
    jester = { accent = "magenta", border = "dark_slate_grey", text = "light_yellow", muted = "light_grey" },
    magi = { accent = "dodger_blue", border = "navy", text = "alice_blue", muted = "light_steel_blue" },
    monk = { accent = "burlywood", border = "saddle_brown", text = "ivory", muted = "wheat" },
    occultist = { accent = "medium_purple", border = "dark_slate_blue", text = "lavender_blush", muted = "thistle" },
    paladin = { accent = "gold", border = "steel_blue", text = "ivory", muted = "light_goldenrod_yellow" },
    pariah = { accent = "dim_grey", border = "black", text = "white_smoke", muted = "grey" },
    priest = { accent = "light_goldenrod", border = "dark_khaki", text = "white", muted = "light_yellow" },
    psion = { accent = "deep_sky_blue", border = "dark_slate_grey", text = "light_cyan", muted = "powder_blue" },
    runewarden = { accent = "royal_blue", border = "dark_slate_gray", text = "alice_blue", muted = "light_slate_gray" },
    sentinel = { accent = "olive_drab", border = "dark_green", text = "honeydew", muted = "dark_sea_green" },
    serpent = { accent = "chartreuse", border = "dark_green", text = "honeydew", muted = "pale_green" },
    ...
    unnamable = { accent = "orchid", border = "midnight_blue", text = "lavender", muted = "thistle" },
...
function agnosticdb.ui.show_config()
  ...
  toggle_line("Announce changes only", "api.announce_changes_only", conf.api.announce_changes_only)
  line(separator())
  line(section("Honors"))
...
function agnosticdb.ui.fetch_and_show(name)
  agnosticdb.api.fetch(name, function(person, status)
    ...
    local announce_changes_only = agnosticdb.conf and agnosticdb.conf.api and agnosticdb.conf.api.announce_changes_only
    local should_announce = true
    if announce_changes_only and (status == "unchanged" or status == "cached") then
