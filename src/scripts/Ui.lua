...
local function builtin_themes()
  return {
    ...
    mhaldor = { accent = "red", border = "dark_slate_grey", text = "misty_rose", muted = "rosy_brown" },
    ...
    blademaster = { accent = "slate_gray", border = "dark_slate_grey", text = "white_smoke", muted = "light_slate_gray" },
    ...
    occultist = { accent = "dark_turquoise", border = "dark_orchid", text = "alice_blue", muted = "cadet_blue" },
    paladin = { accent = "gold", border = "slate_blue", text = "ivory", muted = "light_goldenrod_yellow" },
    pariah = { accent = "sandy_brown", border = "dark_slate_grey", text = "ivory", muted = "tan" },
    priest = { accent = "light_goldenrod", border = "slate_gray", text = "white", muted = "light_yellow" },
    psion = { accent = "deep_sky_blue", border = "dark_orchid", text = "light_cyan", muted = "powder_blue" },
    runewarden = { accent = "royal_blue", border = "peru", text = "alice_blue", muted = "light_slate_gray" },
    sentinel = { accent = "olive_drab", border = "dark_olive_green", text = "honeydew", muted = "dark_sea_green" },
...
function agnosticdb.ui.show_commands(include_status)
  ...
  line(separator())
  line(section("Lua API"))
  entry("Getter helpers", "see README for agnosticdb.getPerson/getCity/etc.")
  line(separator())
  line(footer_line())
  if include_status then
    cecho("\n")
