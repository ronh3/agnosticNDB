...
local function builtin_themes()
  return {
    ...
    depthswalker = { accent = "dark_turquoise", border = "dark_slate_grey", text = "light_cyan", muted = "cadet_blue" },
    ...
    pariah = { accent = "dim_grey", border = "dark_slate_grey", text = "white_smoke", muted = "grey" },
